#ifndef DV_QKD_LDPC_TX_ERROR_CORRECTION_H_
#define DV_QKD_LDPC_TX_ERROR_CORRECTION_H_
...
class DvQkdLdpcTxErrorCorrection : public Block
{
...
public:
	...
	DvQkdLdpcTxErrorCorrection(std::initializer_list<Signal*> InputSig, std::initializer_list<Signal*> OutputSig) : Block(InputSig, OutputSig) {};
...
private:
	...
	DvQkdLdpcTxErrorCorrection::t_role errorCorrectionRole{ t_role::Tx };
	DvQkdLdpcTxErrorCorrection::t_method errorCorrectionMethod{ t_method::LDPC };
	DvQkdLdpcTxErrorCorrection::t_mode errorCorrectionMode{ t_mode::InverseReconciliation };
