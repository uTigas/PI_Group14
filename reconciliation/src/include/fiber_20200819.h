...
// This block uses the overlap save method
...
public:
	...
	Fiber(std::vector<Signal*> InputSig, std::vector<Signal*> OutputSig) :Block(InputSig, OutputSig) {};
	...
	void setStepLength(t_real sLength_m) { stepLength_m = sLength_m; }
	t_real getStepLength(void) { return stepLength_m; }
...
private:
	...
	bool saveSignalDuringPropagation{ true };
	std::string saveSignalDuringPropagationFolder{ "Fiber" };
