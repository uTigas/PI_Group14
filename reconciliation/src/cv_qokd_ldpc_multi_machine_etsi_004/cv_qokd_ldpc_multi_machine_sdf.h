...
public:
	...
	t_string asciiFolderName{ "oblivious_keys" };
	...
	void initializeInputParameterMap()
	{
		...
		addInputParameter("keySource", &keySource);
		addInputParameter("saveKeys", &saveKeys);
		addInputParameter("rawKeyFolder", &rawKeyFolder);
		...
		addInputParameter("etsiPort", &etsiPort);
		addInputParameter("etsiAddress", &etsiAddress);
		addInputParameter("node1_uuid", &node1_uuid);
		addInputParameter("node2_uuid", &node2_uuid);
		addInputParameter("App", &App);
		addInputParameter("keyStreamId", &keyStreamId);
		addInputParameter("asciiFileNameTailNumberModulos", &asciiFileNameTailNumberModulos);
		addInputParameter("asciiFolderName", &asciiFolderName);
		addInputParameter("insertEndLine", &insertEndLine);
		addInputParameter("replacePreviousKeys", &replacePreviousKeys);
