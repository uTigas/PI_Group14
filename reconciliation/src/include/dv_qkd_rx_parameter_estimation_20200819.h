#ifndef DV_QKD_RX_PARAMETER_ESTIMATION_H_
#define DV_QKD_RX_PARAMETER_ESTIMATION_H_
...
class DvQkdRxParameterEstimation : public Block {

public:

	//##############################################################################################################

	DvQkdRxParameterEstimation(std::initializer_list<Signal*> InputSig, std::initializer_list<Signal*> OutputSig) :
	...
	DvQkdRxParameterEstimation(std::initializer_list<Signal*> InputSig, std::initializer_list<Signal*> OutputSig, std::string bFolderName) :
		Block(InputSig, OutputSig),
	...
	DvQkdRxParameterEstimation(std::initializer_list<Signal*> InputSig, std::initializer_list<Signal*> OutputSig, std::string bFolderName, std::string bFileName) :
		Block(InputSig, OutputSig),
		outputFolderName{ bFolderName + "/" },
	...
	DvQkdRxParameterEstimation(std::initializer_list<Signal*> InputSig, std::initializer_list<Signal*> OutputSig, std::string bFolderName, std::string bFileName, std::string bLFileName) :
		Block(InputSig, OutputSig),
		outputFolderName{ bFolderName + "/" },
		reportOutputFileName{ bFileName },
