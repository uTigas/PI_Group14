...
bool ParameterEstimation::selectBitsToUse(const t_seed seedVal, const int64_t nBits, std::vector <t_integer>& vectorInputKey, std::vector <t_integer>& vectorBitsToUse, int64_t intervalSize)
{
	bool alive = false;
...
/*
bool ParameterEstimation::sendToMsg(std::vector <t_integer>& data, Signal& signalToMsg, bool& started) {
