#ifndef DV_QKD_LDPC_RX_MESSAGE_PROCESSOR_TRANSMITTER_H_
#define DV_QKD_LDPC_RX_MESSAGE_PROCESSOR_TRANSMITTER_H_

#include "netxpto_20200819.h"
#include "dv_qkd_message_processor_common_20200819.h"

class DvQkdLdpcRxMessageProcessorTransmitter : public Block 
{
public:

	DvQkdLdpcRxMessageProcessorTransmitter(std::initializer_list<Signal*> InputSig, std::initializer_list<Signal*> OutputSig) : Block(InputSig, OutputSig) {};
...
private:
	...
	CircularBuffer<t_binary> BasesTo{ messageReconciliationMaximumDataLength };
