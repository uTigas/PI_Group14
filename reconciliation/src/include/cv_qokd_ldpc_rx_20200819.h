#ifndef CV_QOKD_RX_LDPC_H_
#define CV_QOKD_RX_LDPC_H_
...
public:
	...
	*/
	...
	void setBypassErrorCorrection(t_bool bErrorCorrection) { CvQokdLdpcRxSindromeReconciliation_.setBypassErrorCorrection(bErrorCorrection); };
	...
	void setLdpcErrorCorrectionAlgorithMaxIterations(t_integer lErrorCorrectionAlgorithMaxIterations) { CvQokdLdpcRxSindromeReconciliation_.setLdpcErrorCorrectionAlgorithMaxIterations(lErrorCorrectionAlgorithMaxIterations); };
	t_integer getLdpcErrorCorrectionAlgorithMaxIterations(t_integer lErrorCorrectionAlgorithMaxIterations) const { CvQokdLdpcRxSindromeReconciliation_.getLdpcErrorCorrectionAlgorithMaxIterations(); };

	void setCodeLength(t_integer cLength) { CvQokdLdpcRxSindromeReconciliation_.setCodeLength(cLength); };
	t_integer getCodeLength(void) const { CvQokdLdpcRxSindromeReconciliation_.getCodeLength(); };

	void setCodeRank(t_integer cRank) { CvQokdLdpcRxSindromeReconciliation_.setCodeRank(cRank); };
	t_integer getCodeRank(void) const { CvQokdLdpcRxSindromeReconciliation_.getCodeRank(); };

	void setNumberOfNonZerosValuesInSparseParityCheckMatrix(t_integer nOfNonZerosValuesInSparseParityCheckMatrix) { CvQokdLdpcRxSindromeReconciliation_.setNumberOfNonZerosValuesInSparseParityCheckMatrix(nOfNonZerosValuesInSparseParityCheckMatrix); };
	t_integer getNumberOfNonZerosValuesInSparseParityCheckMatrix(void) const { CvQokdLdpcRxSindromeReconciliation_.getNumberOfNonZerosValuesInSparseParityCheckMatrix(); };

	void setNumberOfDataBitsPerBitFillingPeriod(t_integer nOfDataBitsPerBitFillingPeriod) { CvQokdLdpcRxSindromeReconciliation_.setNumberOfDataBitsPerBitFillingPeriod(nOfDataBitsPerBitFillingPeriod); }
	t_integer getNumberOfDataBitsPerBitFillingPeriod() const { return CvQokdLdpcRxSindromeReconciliation_.getNumberOfDataBitsPerBitFillingPeriod(); }

	void setNumberOfDummyBitsPerBitFillingPeriod(t_integer nOfDummyBitsPerBitFillingPeriod) { CvQokdLdpcRxSindromeReconciliation_.setNumberOfDummyBitsPerBitFillingPeriod(nOfDummyBitsPerBitFillingPeriod); }
	t_integer getNumberOfDummyBitsPerBitFillingPeriod() const { return CvQokdLdpcRxSindromeReconciliation_.getNumberOfDummyBitsPerBitFillingPeriod(); }
...
//	Binary TransmissionMode_In{ "S3_TransmissionMode_In.sgn", buffSize,  hType, sWriteMode };
	...
	CvQokdLdpcRxSindromeReconciliation CvQokdLdpcRxSindromeReconciliation_{ {&DvQkdLdpcRxParameterEstimation_DataOut, &SindromeFromTx, &DvQkdLdpcRxParameterEstimation_EstimatedQBER}, {&DataCorr, &SindromeToTx, &PermutationsToSend, &ToggleBERChange} };
