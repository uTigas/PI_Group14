...
void DvQkdLdpcTxErrorCorrection::initialize(void)
{
	if (errorCorrectionMethod == DvQkdLdpcTxErrorCorrection::t_method::LDPC)
	{
...
bool DvQkdLdpcTxErrorCorrection::runBlock(void)
{
	...
	if (receivedData_newData && calculatedSindrome_posIn == 0 && calculatedSindrome_newData == false)
	{
		...
		if (startSendingSindrome) calculatedSindrome_posOut = 0;
...
t_bool DvQkdLdpcTxErrorCorrection::errorCorrectionLDPCAlgorithm()
{
...
void DvQkdLdpcTxErrorCorrection::loadSparseParityCheckMatrix()
{
