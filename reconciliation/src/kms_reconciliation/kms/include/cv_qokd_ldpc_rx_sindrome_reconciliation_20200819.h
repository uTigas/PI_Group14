...
class CvQokdLdpcRxSindromeReconciliation : public Block
{
...
public:
	...
	CvQokdLdpcRxSindromeReconciliation(std::initializer_list<Signal*> InputSig, std::initializer_list<Signal*> OutputSig) : Block(InputSig, OutputSig) {};
	...
	void setHashLength(t_integer hSize) { hashLength = hSize; }
	t_integer getHashLength(void) const { return hashLength; }
	...
	unsigned long int getNumberOfValidatedSindromes() const { return numberOfValidatedSindromes; }

	unsigned long int getNumberOfNoMatchedSindromes() const { return numberOfNoMatchedSindromes; }

	unsigned long int getNumberOfMatchedSindromes() const { return numberOfMatchedSindromes; }
...
private:
	...
	CvQokdLdpcRxSindromeReconciliation::t_role errorCorrectionRole{ t_role::Rx };
	CvQokdLdpcRxSindromeReconciliation::t_method errorCorrectionMethod{ t_method::LDPC };
	CvQokdLdpcRxSindromeReconciliation::t_mode errorCorrectionMode{ t_mode::DirectReconciliation };
	...
	unsigned long int numberOfValidatedSindromes{ 0 };
	unsigned long int numberOfNoMatchedSindromes{ 0 };
	unsigned long int numberOfMatchedSindromes{ 0 };
	...
	t_bool sindromeMatch_0{ false };
	t_bool sindromeMatch_1{ false };
	...
	std::vector<t_binary> receivedHash;
